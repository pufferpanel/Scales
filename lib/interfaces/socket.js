...
HttpsServer.listen(Config.global.listen.socket, Config.global.listen.host || '0.0.0.0', function () {
    Logger.info('Scales is now listening to Socket.IO on port ' + Config.global.listen.socket);
});

HttpsServer2.listen(Config.global.listen.uploads, Config.global.listen.host || '0.0.0.0', function () {
