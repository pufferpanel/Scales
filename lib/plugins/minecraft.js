...
Plugin.prototype.queryServer = function () {
    ...
    Gamedig.query({
        ...
        if (res.error) {
            ...
            Logger.verbose('Query error encountered for ' + self.serverConfig.gamehost + ':' + self.serverConfig.gameport, res.error);
            return false;
        }
            ...
            Properties.parse(propertiesPath, { path: true }, function (err, obj) {
                ...
                if (rewrite) {
                    ...
                    Properties.stringify(obj, { path: propertiesPath }, function (err, object) {
                        ...
                        log.verbose('Completed plugin preflight for ' + self.serverConfig.name);
                        return next();
