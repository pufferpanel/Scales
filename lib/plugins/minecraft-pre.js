 ...
 *
 * minecraft-pre.js — Adds Minecraft Server (pre 1.8) support to Scales.js
 */
...
settings = {
	...
	stop: "stop",
	exe: "java",
	jar: "data/plugins/minecraft-pre/minecraft.jar",
...
settings.preflight = function(config, basePath, callback) {
	...
	if(fs.existsSync(propertiesPath)) {
		...
		log.verbose("Completed plugin preflight for " + config.name + " but we need to restart the server right after because the server.properties file isn't generated yet.");
		callback(null, 1);
