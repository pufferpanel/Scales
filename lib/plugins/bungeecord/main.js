        ...
        if (stats.isFile()) {
            ...
            try {
                ...
                if (yml.listeners[0]) {
                    ...
                    yml.listeners[0].host = Util.format('%s:%s', self.useDocker ? '0.0.0.0' : self.serverConfig.gamehost.toString(), self.serverConfig.gameport.toString());
                }
