...
var Scales = function (config) {
    ...
    this.controller = new SystemControl(((typeof GlobalConfig.docker === 'undefined') || (GlobalConfig.docker) == true), this);
    this.plugin = new Plugin(this.getRootPath(), this.buildPath(), this.config, ((typeof GlobalConfig.docker === 'undefined') || (GlobalConfig.docker) == true));
