 ...
 */
Scales.prototype.attachDockerContainer = function () {
 ...
 * @return {object}
 */
Scales.prototype.detachDockerContainer = function () {
...
Scales.prototype.powerOn = function (next) {
    ...
    var self = this;
    // Add Docker Logic
    this.ps = this.attachDockerContainer();

    this.ps.on('data', function (data) {
        console.log('root@~docker# ' + data);
    });

    this.ps.write('whoami\r');
    this.ps.write('ls\r');

    this.detachDockerContainer();
