...
Scales.prototype.install = function (res, hash, password, build_params) {
    ...
    Async.series([
        ...
        function (next) {
            ...
            // docker create -it --name pp-vanill_4o2fd -h docker -p 25566:25565 -m 256M -c 100 --blkio-weight=100 -u `stat -c "%u:%g" /home/pp-vanill_4o2fd/public` -v /home/pp-vanill_4o2fd/public:/data minecraft
